...
<?php $__env->startSection('page-header'); ?>
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			...
			<li class="breadcrumb-item" aria-current="page"><a href="<?php echo e(route('user.templates')); ?>"> <?php echo e(__('Templates')); ?></a></li>
			...
			<div class="card overflow-hidden border-0">
				<div class="card-body">		
					...
					<div class="d-flex mb-3">
						...
						<div>
							<a id="save-button" class="template-button" target="<?php echo e($id->id); ?>" onclick="return saveText(this);" href="#" data-tippy-content="Save Changes"><i class="fa-solid fa-floppy-disk-pen table-action-buttons delete-action-button"></i></a>
						</div>					
					</div>
...
unset($__errorArgs, $__bag); ?>" id="document" name="document" value="New Document">
...
unset($__errorArgs, $__bag); ?>
					...
					<div>						
						<div id="template-textarea" class="pl-4 pr-4">						
							<div class="form-control" name="content" rows="12" id="richtext"><?php echo e($id->result_text); ?></div>
...
unset($__errorArgs, $__bag); ?>	
					...
					<div class="border-0 text-right mb-4 mr-4">
						<a href="<?php echo e(route('user.templates')); ?>" class="btn btn-primary"><?php echo e(__('Return')); ?></a>
					</div>
				</div>
			</div>
		</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sorjuana/resources/views/user/documents/workbooks/show.blade.php ENDPATH**/ ?>