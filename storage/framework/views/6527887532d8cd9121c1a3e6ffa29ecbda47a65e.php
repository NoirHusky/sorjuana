                    ...
                    <div class="col-md-6 col-sm-12 mt-8">   
                        ...
                        <div class="card overflow-hidden border-0 special-shadow">	
                            ...
                            <div class="card-body" id="manual-activation">                                                  
                                ...
                                <h3 class="text-center font-weight-bold fs-16 mb-4 mt-3"><?php echo e(__('Manual License Activation')); ?></h3>
                                ...
                                <form action="<?php echo e(route('admin.settings.activation.manual.store')); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div id="install-wrapper">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12">								
                                                <div class="input-box">								
                                                    <h6><?php echo e(__('License Code')); ?></h6>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">								
                                                <div class="input-box">								
                                                    <h6><?php echo e(__('Envato Username')); ?></h6>
                                                    <div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group mb-0 text-center">                        
                        <button type="submit"  class="btn btn-primary pr-7 pl-7"><?php echo e(__('Activate')); ?></button>                                               
                    </div>
                </form>    
            </div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sorjuana/resources/views/admin/settings/activation/manual.blade.php ENDPATH**/ ?>