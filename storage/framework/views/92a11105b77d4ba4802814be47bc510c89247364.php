						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12 mt-2">
								<div>
									...
									<p class="fs-12 font-weight-800 mb-2"><?php echo e(__('Current Available Words')); ?>: <span class="font-weight-normal ml-2"><?php echo e(number_format($user->available_words + $user->available_words_prepaid)); ?></span></p>
									<p class="fs-12 font-weight-800 mb-2"><?php echo e(__('Current Available Images')); ?>: <span class="font-weight-normal ml-2"><?php echo e(number_format($user->available_images + $user->available_images_prepaid)); ?></span></p>
								</div>
							</div>
...
unset($__errorArgs, $__bag); ?>									
							...
							<div class="col-sm-12 col-md-12 mt-3">
								<div class="input-box">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-800"><i class="fa-solid fa-image mr-2 text-info"></i><?php echo e(__('Type image quantity to add')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sorjuana/resources/views/admin/users/list/increase.blade.php ENDPATH**/ ?>