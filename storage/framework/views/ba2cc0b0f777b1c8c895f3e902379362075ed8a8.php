				...
				<div class="card-body p-0">
					<table class="table" id="database-backup">
						<tbody>
							...
							<tr><td class="justify-content-between d-flex align-items-center pl-5 pr-5 pt-4 pb-4"><span class="font-weight-bold"><?php echo e(__('Supported Templates')); ?></span><?php echo e(ucfirst($id->templates)); ?></td></tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sorjuana/resources/views/admin/finance/plans/show.blade.php ENDPATH**/ ?>