			...
			<div class="card border-0">
				...
				<div class="card-body pt-5">		
					...
					<div class="row pt-5">
						...
						<div class="col-lg-4 col-md-4 col-12">
							<h6 class="font-weight-bold mb-1"><?php echo e(__('Included Images')); ?>: </h6>
							<span class="fs-14"><?php echo e(number_format($id->images)); ?></span>
						</div>
					</div>			
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sorjuana/resources/views/admin/finance/plans/prepaid/show.blade.php ENDPATH**/ ?>