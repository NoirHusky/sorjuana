			...
			<div class="card overflow-hidden border-0">
				...
				<div class="card-body pt-5">		
					...
					<div class="border-0 text-right mb-2 mt-8">
						<a href="<?php echo e(route('admin.notifications')); ?>" class="btn btn-primary"><?php echo e(__('Return')); ?></a>
					</div>
				</div>
			</div>
		</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sorjuana/resources/views/admin/notification/show.blade.php ENDPATH**/ ?>