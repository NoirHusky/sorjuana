...
<?php $__env->startSection('js'); ?>
    ...
    <script type="text/javascript">
		...
		.then(function(result){
			if (result.error) {
				window.location.replace("<?php echo e(route('user.payments.subscription.cancelled')); ?>");
			} else {
				window.location.replace("<?php echo route('user.payments.subscription.approved', ['plan_id' => $plan_id, 'subscription_id' => $subscription_id]); ?>");
			}
		});
	</script>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sorjuana/resources/views/user/plans/3d-secure-subscription.blade.php ENDPATH**/ ?>