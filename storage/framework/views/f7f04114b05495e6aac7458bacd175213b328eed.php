					...
					<div class="row mt-5 ml-4 mr-4">						
						<div class="col-md-6 col-sm-12">							
							<div class="input-box">		
								...
								<p class="fs-12"><?php echo e(__('First Successful Subscription Plan Registration')); ?></p>
							</div>
						</div>
					</div>
...
unset($__errorArgs, $__bag); ?> border-right-0 browse-file" id="email" name="email" placeholder="Email address">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sorjuana/resources/views/user/referrals/index.blade.php ENDPATH**/ ?>