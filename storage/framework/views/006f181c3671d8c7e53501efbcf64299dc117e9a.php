									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											...
											<select id="default-model-user" name="model" data-placeholder="<?php echo e(__('Select OpenAI Model Type')); ?>:">			
												...
												<option value="gpt-3.5-turbo" <?php if($id->model == 'gpt-3.5-turbo'): ?> selected <?php endif; ?>><?php echo e(__('ChatGPT')); ?> (<?php echo e(__('3.5 Turbo')); ?>)</option>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											...
											<select id="templates" name="templates" data-placeholder="<?php echo e(__('Set Templates Access')); ?>">
												...
												<option value="professional" <?php if($id->templates == 'professional'): ?> selected <?php endif; ?>> <?php echo e(__('Only Professional Templates')); ?></option>																															
												<option value="standard" <?php if($id->templates == 'standard'): ?> selected <?php endif; ?>> <?php echo e(__('Only Standard Templates')); ?></option>																																																													
											</select>
										</div>
									</div>
								</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sorjuana/resources/views/admin/finance/plans/edit.blade.php ENDPATH**/ ?>