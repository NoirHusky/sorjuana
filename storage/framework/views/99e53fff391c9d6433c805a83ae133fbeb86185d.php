...
<?php $__env->startSection('page-header'); ?>
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0"><?php echo e(__('Edit Customer Review')); ?></h4>
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(url('#')); ?>"> <?php echo e(__('Edit Customer Review')); ?></a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
		...
		<div class="col-lg-8 col-md-8 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-header">
					<h3 class="card-title"><?php echo e(__('Edit Customer Review')); ?></h3>
				</div>
				<div class="card-body pt-5">									
					<form id="" action="<?php echo e(route('admin.settings.review.update', [$id->id])); ?>" method="POST" enctype="multipart/form-data">
							...
							<div class="col-lg-12 col-md-12 col-sm-12">							
								<div class="input-box">								
									...
									<div class="form-group">							    
										<input type="text" class="form-control" id="name" name="name" value="<?php echo e($id->name); ?>" required>
									</div> 
...
unset($__errorArgs, $__bag); ?>	
							...
							<div class="col-lg-12 col-md-12 col-sm-12">							
								<div class="input-box">								
									...
									<div class="form-group">							    
										<input type="text" class="form-control" id="position" name="position" value="<?php echo e($id->position); ?>" required>
									</div> 
...
unset($__errorArgs, $__bag); ?>	
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="input-box">
									<h6><?php echo e(__('Customer Avatar')); ?></h6>
						...
						<div class="row mt-2">
							<div class="col-lg-12 col-md-12 col-sm-12">	
								<div class="input-box">	
									...
									<textarea class="form-control" name="text" rows="12" id="richtext" required><?php echo e($id->text); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sorjuana/resources/views/admin/frontend/review/edit.blade.php ENDPATH**/ ?>