			...
			<div class="card border-0">
				...
				<div class="card-body text-center">				
					<div>
						...
						<a href="<?php echo e(route('admin.user.credit', [$user->id])); ?>" class="btn btn-primary mt-3 mb-2"><i class="fa-solid fa-scroll-old mr-1"></i><?php echo e(__('Add Words & Images')); ?></a>
					</div>
				</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sorjuana/resources/views/admin/users/list/show.blade.php ENDPATH**/ ?>